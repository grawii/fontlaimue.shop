...
/* ==========================================
   3. UNIFIED LOGIN CONTROLLER & AUTO-LOGIN GEAR
   ========================================== */
...
function verifySlipWithAPI() {
    ...
    .then(res => {
        setTimeout(() => {
            ...
            document.getElementById('topupPageAmount').value = "";
            fileInput.value = "";
            document.getElementById('slipUploadPlaceholder').innerHTML = `<i class="fa-solid fa-cloud-arrow-up text-xl text-main"></i><p class="text-[10px] font-bold">คลิกเพื่อเลือกไฟล์รูปภาพสลิป</p>`;
            
            verifyBtn.disabled = false;
            verifyBtn.innerHTML = `<i class="fa-solid fa-shield-check"></i> ตรวจสอบสลิปและเติมเครดิต`;
